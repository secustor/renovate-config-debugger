 ...
 *
 * The repository's CURRENT name: GitHub renamed the repository to
 * `renovate-config-debugger` (the app's own title since 016), and the
 * pre-rename name lives on as a redirect. Verified against
