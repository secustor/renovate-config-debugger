...
/** Octicon `copy`, inlined — the entry chunk carries no icon dep (031). The
 *  check is shared with ShareButton, so it lives in `data/octicons`. */
const COPY_PATH =
