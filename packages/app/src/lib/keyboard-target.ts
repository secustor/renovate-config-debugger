/**
 * Roadmap 068 — "who owns this key?", asked of the event TARGET. Pure DOM
 * predicates, shared by every keyboard consumer: the 016 Home/End page scroll
 * (`hooks/scroll-ergonomics.ts`), the bare-key jump layer (`use-shortcut.ts`,
 * `use-tab-digits.ts`) and the Escape ladder (`use-escape-layer.ts`).
 */
