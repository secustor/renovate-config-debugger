...
import { focusAddTestForm } from "./pin-add-dom";
 ...
 * form already on screen below, and offers the quick-fill descriptors as
 * "common cases" — clicking one seeds the form rather than pinning, because
 * no pin is ever created for the reader (075 iteration 6).
 */
...
export function EmptyTestsCard({
  ...
  return (
    <div className="pin-empty-card">
      ...
      <button type="button" className="btn-primary" onClick={focusAddTestForm}>
        + Pin a dependency…
      </button>
