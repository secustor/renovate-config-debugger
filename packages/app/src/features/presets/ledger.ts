...
/** The DOM id of a source's card, spelled once: the ledger's summary strip
 *  scrolls to it, and the card itself carries it. */
...
const CONFIG_PRESETS_DOCS = "https://docs.renovatebot.com/config-presets/";
...
export function computePresetLedger(root: PresetNode): PresetLedgerModel {
  ...
  const model: PresetLedgerModel = { sources, summary: stats.summary };
